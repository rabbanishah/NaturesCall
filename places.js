...
var lon = '77.5652'
var type = 'hospital'
var name = 'KFC | hospital | MSRIT |BurgerKing | CafeCoffeeDay'
var rankby = 'distance'
...
request(url, function (error, response, body) {
  if (!error && response.statusCode == 200) {
    ...
    for(var i = 0 ; i < places.length ; i++) {
        ...
        temp.distance = geolib.getDistance({'latitude':lat,'longitude':lon},{'latitude':temp.location.lat,'longitude':temp.location.lng})
